...
import './LikeThree.css';

const LikeThree = () => {
    return (
        <div  className="Likethree-out-container">

        <div className="Likethree-container">
            <label className="Likethree-box Likethree-like">
                <input type="checkbox" />
                <svg className="Likethree-icon" width="36" height="36" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
                    <path
                        fillRule="evenodd"
                        clipRule="evenodd"
            ...
            <label className="Likethree-box Likethree-coin">
                <input type="checkbox" />
                <svg className="Likethree-icon" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                    <path
                        fillRule="evenodd"
                        clipRule="evenodd"
            ...
            <label className="Likethree-box Likethree-collect">
                <input type="checkbox" />
                <svg className="Likethree-icon" width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                    <path
                        fillRule="evenodd"
